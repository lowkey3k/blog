...
<div class="modal fade" id="reward" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">猿猿相报何时了</h4>
            </div>
            <div class="modal-body">
    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            ...
            <div style="padding: 4px;padding-left: 10px;">
                <p style="white-space: initial;">技术记录与分享</p>
                <p style="white-space: initial;">记录技术成长之路。</p>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4 text-left fade-in">
            <h4>问题交流</h4>
            <div class="row" style="padding: 4px;padding-left: 10px;">
                <div class="col-xs-12 col-sm-7 col-md-7" style="white-space: initial;">
                    <#--<span>志同道合者欢迎进QQ交流群(122631603)</span>-->
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5">
                    <a href="${config.staticWebSite}/img/qq_group.jpg" class="showImage" title="QQ群(122631603)二维码" rel="external nofollow">
                        <img data-original="${config.staticWebSite}/img/qq_group.png" alt="QQ群(122631603)二维码" class="img-responsive img-rounded auto-shake lazy-img" style="width: 100px;">
                    </a>
                </div>
            </div>
        </div>
