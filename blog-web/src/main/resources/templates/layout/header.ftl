    ...
    <div class="menu-box">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <div class="pull-left site-desc" style="line-height: 0.9;">
                <h1 style="font-size: 20px;font-weight: 700;" class="auto-shake"><a href="${config.siteUrl}" data-original-title="分享技术成长之路" data-toggle="tooltip" data-placement="bottom">${config.siteName}</a></h1>
                <p class="site-description">分享技术成长之路</p>
            </div>
            <ul class="nav navbar-nav ">
                <li>
                    <a href="/blog-web-2.0.1.Beta/" class="menu_a"><i class="fa fa-home"></i>首页</a>
                </li>
                            ...
                            <#if item.nodes?exists && item.nodes?size gt 0>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="/blog-web-2.0.1.Beta/type/${node.id?c}" title="点击查看《${node.name?if_exists}》的文章">${node.name?if_exists}</a></li>
                                        </#list>
                                    </ul>
                                </li>
                            <#else>
                                <li><a href="/blog-web-2.0.1.Beta/type/${item.id?c}" class="menu_a"><i class="${item.icon?if_exists}"></i>${item.name?if_exists}</a></li>
                            </#if>
                        </#list>
                    </#if>
                </@zhydTag>
                <li><a href="/blog-web-2.0.1.Beta/guestbook" class="menu_a"><i class="fa fa-comments-o"></i>留言板</a></li>
